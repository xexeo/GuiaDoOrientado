...
No momento as principais informações relevantes para os alunos da Coppe podem ser encontradas no site da Coppe, na seção \textbf{Espaço do Aluno}~\feurl{https://coppe.ufrj.br/espaco-do-aluno/}{Espaço dos alunos da COPPE - site de apoio}. 
Lá está o a regulamentação original\feurl{https://coppe.ufrj.br/wp-content/uploads/2024/06/Alunos_a_partir_2017.1.pdf}{Regulamentação da Coppe a partir de 2017} e ainda vários documentos e decisões adicionais.
